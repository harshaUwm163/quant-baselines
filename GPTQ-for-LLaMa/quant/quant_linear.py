...
class QuantLinear(nn.Module):
    ...
    def __init__(self, bits, groupsize, infeatures, outfeatures, bias):
        ...
        self.register_buffer('qweight', torch.zeros((infeatures, outfeatures), dtype=torch.int32))
        self.register_buffer('qzeros', torch.zeros((math.ceil(infeatures / self.groupsize), outfeatures), dtype=torch.int32))
...
def make_quant_linear(module, names, attn_wbits, mlp_wbits, groupsize, name=''):
