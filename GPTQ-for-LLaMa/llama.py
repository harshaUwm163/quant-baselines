...
if __name__ == '__main__':
    ...
    parser.add_argument('--attn_wbits', type=int, default=16, choices=[2, 3, 4, 6, 8, 16], help='#bits to use for quantization of attn; use 16 for evaluating base model.')
    parser.add_argument('--mlp_wbits', type=int, default=16, choices=[2, 3, 4, 6, 8, 16], help='#bits to use for quantization of mlp; use 16 for evaluating base model.')
